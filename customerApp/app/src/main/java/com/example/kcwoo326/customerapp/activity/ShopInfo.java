...
public class ShopInfo extends Activity {
        ...
        public AlertDialog create() {
            ...
            setPositiveButton("확인", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                        ...
                        ccaretableinsert(strings[0], MainActivity.name, p);
                        //task3 = new PWaitingTableDown();
                        //task3.execute("http://wlsdnghkd123.iptime.org:8080/ccaretable.php");
    ...
    private void ccaretable() {
        // Tag used to cancel the request
        String tag_string_req = "req_ccaretalbe";
        Log.e("num", "1");
                ...
                try {
                    ...
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        if(shopnum.equals(strings[0]) && whetherthecall.equals("0")){
                            ...
                            if(userid.equals(MainActivity.name)) {
                                waiitingNumBtn = (Button) findViewById(R.id.waitingNumbtn);
                                waiitingNumBtn.setEnabled(false);
                                waiitingNumBtn.setText("대기번호 발급 완료");
                            }
    ...
    private void postable() {
        // Tag used to cancel the request
        String tag_string_req = "req_ccaretalbeinsert";
        Log.e("num", "1");
        //pDialog.setMessage("Please wait ...");
        //showDialog();
        StringRequest strReq = new StringRequest(Request.Method.POST,
    ...
    private void ccaretableinsert(final String shopnum, final String userid, final String persons ) {
        // Tag used to cancel the request
       ...
       // showDialog();
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_CCARETABLEINSERT, new Response.Listener<String>() {
