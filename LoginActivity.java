...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputShopNum = (EditText) findViewById(R.id.shopnum);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String shopnum = inputShopNum.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();

                // Check for empty data in the form
                if (!shopnum.isEmpty() && !password.isEmpty()) {
                    // login user
                    checkLogin(shopnum, password);
                } else {
     ...
     * */
    private void checkLogin(final String shopnum, final String password) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String shopnum = user.getString("shopnum");
                        String name = user.getString("name");
                        String created_at = user.getString("created_at");

                        // Inserting row in users table
                        db.addUser(shopnum, name, uid, created_at);
        ...
        Log.e("num",strReq+tag_string_req);
